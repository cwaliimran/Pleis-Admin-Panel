...
const Header: FC<HeaderProps> = ({ links }) => {
  ...
  const { data: organizationResponse, isLoading: isLoadingOrganizations } = useGetOrganizationByCompanyQuery(
    {
...
//   const requiresOrganizationDropdown = (pathname?.startsWith('/super-admin/ticketing') || pathname?.startsWith('/super-admin/reservation')) ?? false;
