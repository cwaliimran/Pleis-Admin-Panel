                                    ...
                                    <div >
                                        <div className="flex flex-col lg:flex-row gap-6">
                                            ...
                                            <div className="w-full lg:w-2/3 flex flex-col gap-4">
                                                ...
                                                {userType === "staff" && <h2 className="text-2xl font-bold text-gray-900 dark:text-white leading-snug">
                                                    {user.surname}
                                                </h2>}
                                                {userType === "staff" && <p className="text-sm text-gray-500 dark:text-gray-400">
