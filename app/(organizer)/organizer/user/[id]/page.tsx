        ...
        <div className="space-y-6 pb-12">
            <Header
                links={[
                    ...
                    { name: "User", href: "/organizer/user/user-list" },
                ...
                <div className="grid grid-cols-12 md:gap-7">
                    <div className="xl:col-span-9 lg:col-span-8 col-span-12">
                                    ...
                                    <div className="flex flex-col lg:flex-row gap-6">
                                        ...
                                        <div className="w-full lg:w-2/3 flex flex-col gap-4">
                                            ...
                                            <div className="flex items-start justify-between text-sm text-gray-500 dark:text-gray-400">
                                                <div className="flex items-center gap-2 flex-wrap">
                                                    ...
                                                    <span className="bg-gray-200 text-gray-800 px-2 py-0.5 rounded-full text-xs font-medium">
                                                        {userType && userType?.slice(0, 1).toUpperCase() + userType?.slice(1)}
                                                    </span>
                                                    <span>Joined: {new Date(user.dateOfAccountCreation).toLocaleDateString()}</span>
                                                </div>
                                            ...
                                            <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                                                {user.fullName} is a {userType && userType?.slice(0, 1).toUpperCase() + userType?.slice(1)} from <strong>{user.region}</strong>. Contact them at{" "}
                                                <strong>{user.email}</strong> or <strong>{user.phoneNumber}</strong>. Account created on{" "}
                                                <strong>{new Date(user.createdAt).toLocaleDateString()}</strong> and last active on{" "}
                                                <strong>{new Date(user.lastActivity).toLocaleDateString()}</strong>.
                                            </p>
                        ...
                        <div className="  rounded-lg">
                            {active === "overview" && <UserOverView userType={userType} user={user} />}
                            ...
                            {active === "booking&loyalty" && (
                                <>
                                    ...
                                    <Card className="dark:bg-secondary shadow-lg mt-4">
                                        ...
                                        <CardContent>
                                            <div className='border rounded-lg'><LoyaltyAndOrderTransaction />
                                            </div>
                                        </CardContent>
                                    </Card>
                                </>
