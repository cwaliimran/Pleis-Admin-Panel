...
//   // Update store.ts file
//   updateStoreFile(moduleNameCamel, fileName);
// }
...
// export const ${moduleNameCamel}Api = createApi({
//   reducerPath: '${moduleNameCamel}Api',
//   baseQuery: customFetchBaseQuery(),
//   tagTypes: ['${moduleNameSingular}'],
...
//     console.log(`✅ Successfully generated: ${outputFile}`);
//     console.log('\n📝 Next steps:');
//     console.log(`1. Add API_ROUTES.${toConstantCase(moduleName)} to your apiRoutes file`);
//     console.log(`2. Add API_ROUTES.${toConstantCase(moduleName)}_BY_ID to your apiRoutes file`);
//     console.log(`3. Import and configure the API in your store`);
//   } catch (error) {
