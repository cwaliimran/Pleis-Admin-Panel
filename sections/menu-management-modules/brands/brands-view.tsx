...
import { useDeleteBrandMutation, useGetBrandsQuery } from '@/store/Reducer/brands-api';
...
const BrandsView = () => {
  ...
  const brands: BrandRecord[] = data?.data || [];
  ...
  return (
    <div>
      ...
      {openModal.value && (
        <BrandModal open={openModal.value} onClose={openModal.onFalse} isEdit={editModal.value} selectedData={selectedRecord} />
      )}
