    ...
    React.useEffect(() => {
        if (initialData) {
            const formData = {
                ...
                phone: initialData.phoneNumber ? `${initialData.phoneNumber.code}${initialData.phoneNumber.number}` : '',
                ...
                representativeName: initialData.companyDetails?.representativeName || '',
                location: initialData.companyDetails?.location
                    ? {
                        fullAddress: initialData.companyDetails.location.fullAddress || '',
                        ...
                        coordinates: initialData.companyDetails.location.coordinates || [0, 0],
                    }
                    : undefined,
            ...
            reset({ ...defaultValues, role: getDefaultRole(userType), location: undefined });
                        ...
                        <div className="mt-1 flex justify-center gap-2">
                            ...
                            >
                                {isLoading ? (
                                    ...
                                    !isEdit ? `Add ${currentRole}` : `Update ${currentRole}`
                                )}
                            </Button>
