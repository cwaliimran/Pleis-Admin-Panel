...
const UserDetailPage: FC<UserDetailPageProps> = ({ id }) => {
    ...
    return (
        <div className="mt-10">
            <div className="grid grid-cols-12 gap-7">
                <div className="md:col-span-9 col-span-12">
                    <Card className="overflow-hidden  p-4  shadow-md">
                        ...
                        <div className='flex items-center md:justify-between mt-4 md:flex-row flex-col gap-4'>
                            <Tabs value={active} onValueChange={setActive} defaultValue="info" className='w-full '>
          ...
          ${active === tab.value ? ' after:content-[""] after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-3/4 after:h-[4px] after:bg-[#71717A] after:rounded-full' : 'text-muted-foreground'}`}
                                        >
                                            {tab.label}
                                        </TabsTrigger>
                                    ))}
                            ...
                            <div className="flex gap-4">
                                <Badge className="bg-blue-200 text-blue-800 w-10 h-10 rounded-full flex items-center justify-center p-0">
                ...
                <div className="md:col-span-3 col-span-12 space-y-4">
