...
const UserOverView: React.FC<{ userType: string | null, user: any }> = ({ userType, user }) => {

    const permissionList = ['Ticketing', 'Loyalty', 'InApp ordering', 'Reservation management'];
            ...
            <div className="grid grid-cols-12 gap-4">
                <div className="lg:col-span-5 col-span-12">
                    ...
                    {userType === "staff" && (<>
                        <Card className="w-full mt-4 shadow-lg dark:bg-secondary">
                            <CardHeader>
                                <CardTitle className="text-slate-500 dark:text-slate-500 text-xl font-semibold">Permissions</CardTitle>
                            </CardHeader>
                        ...
                        <>
                            ...
                            <Card className="shadow-lg dark:bg-secondary bg-white rounded-2xl mt-6">
                                ...
                                <CardContent className="space-y-1 text-sm text-gray-600 dark:text-gray-400">
                                    {/* Name & Description */}
                                    <div className="">
                                        <span className="font-semibold text-gray-500 w-28">Name:</span>
                                        <span className="text-gray-800 dark:text-white">{user.businessDetails.name}</span>
                                    </div>
                                    <div className=" ">
                                        <span className="font-semibold text-gray-500 w-28">Description:</span>
                                        <span className="text-gray-800 dark:text-white">{user.businessDetails.description}</span>
                                    </div>
                                    {/* Website */}
                            ...
                            <Card className="w-full max-w-4xl bg-white dark:bg-secondary mt-6 mb-6 shadow-sm hover:shadow-md transition rounded-2xl">
                                ...
                                <CardContent className=" ">
                                    ...
                                    <div className="space-y-2 flex flex-col justify-center">
                                        <h2 className="text-2xl font-extrabold text-primary mb-1">Tech Summit 2025</h2>
                                        ...
                                        <div className="flex items-center gap-2 text-sm text-muted-foreground">
                                            ...
                                            <span className="font-medium">Aug 1, 2025 – Aug 3, 2025</span>
                                        </div>
                                    </div>
                                    {/* Right: Stats + CTA */}
                                    <div className="flex flex-col  items-start mt-3 gap-4 text-sm">
                                        <div className="space-y-2 text-muted-foreground">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span>
                                                    <span className="font-medium">Budget:</span> <strong className="text-foreground">$5000</strong>
                                                </span>
                                            </div>
                                            <div className="flex items- gap-2">
                                                <UserRound className="w-5 h-5" />
                                                <span>
                                                    <span className="font-medium">Attendees:</span> <strong className="text-foreground">1500</strong>
                                                </span>
                                            </div>
                                            <div className="flex items-center gap-2">
                                                <Globe className="w-5 h-5" />
                                                <span>
                                                    <span className="font-medium">Region:</span> <strong className="text-foreground">North America</strong>
                                                </span>
                                            </div>
                                        </div>
                    ...
                    {userType === "user" && <Card className="mt-4 shadow-lg dark:bg-secondary">
                        <CardHeader>
                    ...
                    <Card className="shadow-lg dark:bg-secondary mt-4">
                        <CardHeader>
                            <h3 className="text-lg font-semibold text-slate-500 ">Wallet Information</h3>
                        </CardHeader>
                        <CardContent className="text-sm">
                            <p className="text-xl"><strong className="text-slate-500 ">Balance:</strong > <span className="text-3xl font-bold">$95.00</span></p>
                            <p><strong className="text-slate-500 ">Recent Transactions:</strong> See more go to transaction tab</p>
                        </CardContent>
                    </Card>
                ...
                <div className="lg:col-span-7 col-span-12">
                        ...
                        <CardContent>
                            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                                {interactions.map((item, index) => (
                                    ...
                                    >
                                        <Card className="p-6 border border-muted dark:bg-muted/50 shadow-md rounded-xl transition-all duration-300 hover:shadow-lg cursor-pointer">
                    ...
                    <Card className="mt-4 shadow-lg dark:bg-secondary">
                        <CardHeader>
                            <h3 className="text-lg font-semibold text-slate-500 ">Loyalty Program Participation</h3>
                        </CardHeader>
                        <CardContent className="space-y-2 text-sm">
                            <p><strong className="text-slate-500 ">Clubs:</strong> Premium Club, EventPlus</p>
                            <p><strong className="text-slate-500 ">Tier & Points:</strong> Gold (1,200 pts), Silver (600 pts)</p>
                            <p><strong className="text-slate-500 ">Global Points:</strong> 1,800 pts</p>
                            <p><strong className="text-slate-500 ">Redeemed:</strong> $40 worth in last 30 days</p>
                        </CardContent>
                    </Card>
                </div>
            </div>
