      ...
      >
        ...
        <div className="space-y-6 p-5">
          ...
          <div>
            ...
            <div className="space-y-2">
              {FILTER_STATUS_OPTIONS.map((option) => (
                <label
                  key={option.id}
                  className="dark:hover:bg-gray-750 flex min-h-[48px] cursor-pointer items-center rounded-lg bg-gray-50 p-3 transition-colors hover:bg-gray-100 dark:bg-gray-800"
                >
                  <Checkbox
          ...
          <div>
            ...
            <div className="space-y-2">
              <label className="dark:hover:bg-gray-750 flex min-h-[48px] cursor-pointer items-center rounded-lg bg-gray-50 p-3 transition-colors hover:bg-gray-100 dark:bg-gray-800">
                <Checkbox
