...
const schema = Yup.object({
  ...
  bonusPointsPerEUR: Yup.number().required('Bonus points per EUR is required').min(0, 'Bonus points per EUR must be at least 0'),
  retainPoints: Yup.number()
    ...
    .test('retain-points-validation', 'Retain points should be less than or equal to entry points', function (value) {
...
const TiersModal = ({ open, onClose, onSubmit, isEdit = false, selectedData }: TierModalProps) => {
  const statusOptions = [
          ...
          <div className="w-full">
            <FormProvider methods={methods} onSubmit={methods.handleSubmit(handleSubmit)}>
              <div className="mt-7 flex w-full flex-col gap-4">
                ...
                <div className="mt-2 grid w-full grid-cols-1 gap-4 md:grid-cols-2">
                  ...
                  <div className="space-y-1">
                    <RHFTextField name="tierName" label="Tier Name" placeholder="Enter tier name" />
                  </div>

                  <div className="space-y-1">
                    <RHFTextField name="bonusPointsPerEUR" label="Bonus Points per EUR" placeholder="0" type="number" min="0" />
                  </div>
                </div>
                ...
                <div className="grid w-full grid-cols-1 gap-1 gap-x-4 md:grid-cols-2">
                  ...
                  <RHFTextField name="entryPoints" label="Entry Points" placeholder="0" type="number" min="0" />

                  <RHFTextField name="retainPoints" label="Retain Points" placeholder="0" type="number" min="0" />
                ...
                {isEdit && (
                  <div className="space-y-1">
                    <RHFSelectField name="status" label="Status" placeholder="Select status" className="w-full" options={statusOptions} />
                  </div>
                )}
              </div>
              ...
              <div className="mt-6 flex items-center justify-center gap-2">
                ...
                <Button type="submit" className="bg-primary hover:bg-primary px-6 text-white">
