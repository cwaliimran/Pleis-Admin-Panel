      ...
      <div className="flex flex-col gap-4 md:gap-8 lg:flex-row">
        ...
        <div className="w-full space-y-2 lg:basis-[60%]">
          ...
          <RHFTextField
            ...
            multiline
            rows={8}
            className="max-w-xl resize-none rounded-lg border-gray-200 bg-[#F8F6F7] break-words whitespace-pre-wrap focus:border-blue-600 sm:min-h-[120px] lg:min-h-[275px] dark:border-zinc-600 dark:hover:border-zinc-500"
          />
        </div>
      </div>
