  ...
  return (
    <div className="space-y-8">
                ...
                <div className="flex w-full items-center gap-3">
                  <label className="flex w-full items-center gap-3 rounded-2xl border-2 border-gray-200 bg-white px-3 py-2 text-gray-700 md:w-[60%] dark:border-zinc-700 dark:bg-[#23272f] dark:text-gray-200">
                    <input
                      ...
                      onChange={(e) => setValue('recurringEnd', e.target.value as 'never' | 'onDate' | 'afterOccurrences')}
      ...
      <div className="mt-22 flex flex-wrap items-center justify-end gap-2">
        ...
        {/* In edit mode, show Update button. In create mode, show Next button */}
        {isEditMode ? (
          isLoading ? (
            <Button
              type="button"
...
//   isUpdatingEvent,
// }: StepTwoProps) => {
//   const isLoading = loading || isUpdatingEvent;
...
//         {/* EDIT MODE: Update button, CREATE MODE: Next button */}
//         {isEditMode ? (
//           isLoading ? (
//             <Button
//               type="button"
...
// // const StepTwo = ({ watch, setValue, recurring, recurringDays, recurringEnd, toggleRecurringDay, setStep, isStepValid }: StepTwoProps) => {
// //   return (
// //     <div className="space-y-8">
// //       {/* Date and time */}
// //       <div className="space-y-6">
