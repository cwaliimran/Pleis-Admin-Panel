...
const StepTwo = ({
  ...
  const isRecurringInstance = Boolean(parentEventId);
    ...
    <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Time24hInput
                ...
                onChange={(value) => setValue('fromTime', value, { shouldDirty: true })}
                className="h-10 w-36 cursor-pointer rounded-4xl border border-gray-200 bg-[#F8F6F7] px-3 py-2 text-[15px] focus:border-blue-600 dark:border-zinc-700 dark:bg-transparent"
              />
            </div>
          </div>
        </div>
      ...
      <div className="mt-22 flex flex-wrap items-center justify-end gap-2">
        <Button
          ...
          variant="outline"
          onClick={() => setStep(1)}
          className="cursor-pointer rounded-4xl py-2 md:mt-2 md:min-w-22.5"
          disabled={isLoading || updateSingleLoading || updateAllLoading}
        >
          Back
        </Button>
        ...
        {isEditMode ? (
          isRecurringInstance ? (
            // Recurring instance: Show two buttons
            <>
              {updateSingleLoading ? (
                <Button
                  type="button"
                ...
                <Button
                  ...
                  disabled={!isStepValid(2) || !hasChanges || updateAllLoading}
            ...
            // Non-recurring or standalone: Show single button
            <>
              {isLoading ? (
                <Button
                  type="button"
