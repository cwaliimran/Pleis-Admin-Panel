...
interface TimeSensitivePricingFeatureProps {
  ...
  onEarlyBirdChange: (value: boolean) => void;
  onLastMinuteChange: (value: boolean) => void;
  isLoading: boolean;
}
          ...
          <div>
            <label className="flex cursor-pointer items-center gap-2">
              <input
                ...
                onChange={(e) => onEarlyBirdChange(e.target.checked)}
                disabled={isLoading}
            ...
            {earlyBirdEnabled && (
              <div className="ml-6 mt-3 grid gap-3 md:grid-cols-2">
                <RHFTextField
          ...
          <div>
            <label className="flex cursor-pointer items-center gap-2">
              <input
                ...
                onChange={(e) => onLastMinuteChange(e.target.checked)}
                disabled={isLoading}
                className="h-4 w-4 rounded text-blue-600"
              />
