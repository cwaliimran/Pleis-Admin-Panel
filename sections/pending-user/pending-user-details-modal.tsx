          ...
          <div className="dark:bg-secondary flex items-center gap-4 rounded-lg border bg-gray-50 p-4">
            ...
            <div className="flex-1">
              ...
              <div className="mt-2 flex gap-2">
                <Badge className="bg-secondary text-white capitalize dark:bg-white dark:text-black">
                  {user?.accountState?.userType || ''}
                </Badge>
                <CustomBadge
                  variant={
            ...
            <div className="grid gap-4">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input
                    id="organization"
                    value={user?.basicInfo?.companyDetails?.name || ''}
                    readOnly
          ...
          <div className="grid gap-4">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input
                  id="companyName"
                  value={user?.basicInfo?.companyDetails?.name || 'N/A'}
                  readOnly
                  className="bg-gray-50 dark:bg-gray-800"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  value={
                    user?.basicInfo?.companyDetails?.bankAccountNumber || 'N/A'
                  }
                  readOnly
                  className="bg-gray-50 dark:bg-gray-800"
                />
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="postalCode"
                  value={
                    user?.basicInfo?.companyDetails?.location?.postalCode ||
                    'N/A'
                  }
                  readOnly
                  className="bg-gray-50 dark:bg-gray-800"
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <Input
                  ...
                  value={
                    user?.basicInfo?.companyDetails?.representativeName || 'N/A'
                  }
                  readOnly
                  className="bg-gray-50 dark:bg-gray-800"
                />
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="country"
                  value={
                    user?.basicInfo?.companyDetails?.location?.country || 'N/A'
                  }
                  readOnly
                  className="bg-gray-50 dark:bg-gray-800"
                />
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="city"
                  value={
                    user?.basicInfo?.companyDetails?.location?.city || 'N/A'
                  }
                  readOnly
                  className="bg-gray-50 dark:bg-gray-800"
                />
