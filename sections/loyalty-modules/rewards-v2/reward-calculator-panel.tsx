 ...
 * points-per-euro rate — swap for `useRewardPointCalculatorMutation` once the
 * V2 endpoint exists.
 */
export const RewardCalculatorPanel: React.FC = () => {
  ...
  return (
    <div className="rounded-lg border border-gray-200 px-4 py-3 dark:border-gray-700/60">
      ...
      <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">Enter an item price to get a suggested point value for menu item rewards.</p>
