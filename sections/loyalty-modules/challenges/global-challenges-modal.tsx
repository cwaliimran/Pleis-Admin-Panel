...
import type { CompanyOption, OrganizationOption, EventOption, TicketOption } from './special-ticket-types';
...
//         // Special Ticket fields mapping
//         companyId: reward?.rewardType === 'specialTicket' ? reward?.companyId || '' : '',
//         organizationId: reward?.rewardType === 'specialTicket' ? reward?.organizationId || '' : '',
//         eventId: reward?.rewardType === 'specialTicket' ? reward?.eventId || '' : '',
//         ticketId: reward?.rewardType === 'specialTicket' ? reward?.ticketId || '' : '',
//       };
