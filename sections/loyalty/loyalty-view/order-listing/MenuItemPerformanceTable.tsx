...
import { menuItemData, menuItemHeadLabel } from './data';

const MenuItemPerformanceTable = () => {
  return (
    <div>
      <div className="rounded-lg border md:m-4">
        <Table className="w-full">
          <TableHeadCustom headLabel={menuItemHeadLabel} />
          <tbody>
            {menuItemData.map((item: any, index: number) => (
