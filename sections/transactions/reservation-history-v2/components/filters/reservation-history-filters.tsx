...
const ReservationHistoryFilters: FC<ReservationHistoryFiltersProps> = ({
  dateBasis,
  onDateBasisChange,
  period,
  onPeriodChange,
        ...
        <div className="min-w-56 flex-1 space-y-1.5">
          ...
          <div className="relative">
            ...
            <Input
              ...
              placeholder="Guest name, phone, voucher code, access code, confirmation number"
              className="pl-9"
            />
          </div>
        </div>
...
export default ReservationHistoryFilters;
