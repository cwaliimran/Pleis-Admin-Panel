...
interface OrderingHistoryFiltersProps {
  dateBasis: string;
...
const OrderingHistoryFilters: FC<OrderingHistoryFiltersProps> = ({
  dateBasis,
  onDateBasisChange,
  period,
  onPeriodChange,
        ...
        <div className="min-w-56 flex-1 space-y-1.5">
          ...
          <div className="relative">
            ...
            <Input
              ...
              placeholder="Order reference, transaction ID, item, delivery location, waiter"
              className="pl-9"
            />
          </div>
        </div>
...
export default OrderingHistoryFilters;
