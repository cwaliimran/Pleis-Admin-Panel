...
const TransactionHistoryPagination: FC<TransactionHistoryPaginationProps> = ({ currentPage, totalPages, totalRecords, shownCount, onPageChange }) => {
...
export default TransactionHistoryPagination;
