...
interface TicketingHistoryFiltersProps {
  dateBasis: string;
...
const TicketingHistoryFilters: FC<TicketingHistoryFiltersProps> = ({
  dateBasis,
  onDateBasisChange,
  period,
  onPeriodChange,
        ...
        <div className="min-w-56 flex-1 space-y-1.5">
          ...
          <div className="relative">
            ...
            <Input
              ...
              placeholder="Ticket ID, Billko item code, holder name / OIB, event, transaction"
              className="pl-9"
            />
          </div>
        </div>
...
export default TicketingHistoryFilters;
