...
import { default as TicketingTransactionTableRow } from './user-all-transaction-table-row';
...
const UserAllTransactionTable: FC<SamplePageProps> = ({
  data = [],
  meta,
  title,
  loading,
      ...
      <div className="grid grid-cols-12">
        <Card className="dark:bg-secondary col-span-12 mt-5 mb-5 px-2 shadow-md md:px-8 lg:col-span-12">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <h3 className="ml-2 text-xl font-semibold md:ml-0">{title || 'User All Transaction List'}</h3>
...
export default UserAllTransactionTable;
