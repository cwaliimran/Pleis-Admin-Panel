...
interface LoyaltyFiltersPanelProps {
  open: boolean;
...
const LoyaltyFiltersPanel: FC<LoyaltyFiltersPanelProps> = ({ open, onOpenChange, values, onApply, onClear }) => {
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="flex w-full flex-col gap-0 p-0 sm:max-w-xl md:max-w-2xl">
        <SheetHeader className="border-b border-gray-200 dark:border-gray-700">
          <SheetTitle>Filters — Loyalty history</SheetTitle>
        </SheetHeader>
...
export default LoyaltyFiltersPanel;
