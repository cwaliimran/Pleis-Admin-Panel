...
interface CategoriesTypeModalProps {
  open: boolean;
  onClose: () => void;
  editMode: boolean;
  isLoading: boolean;
...
const CategoriesTypeModal: React.FC<CategoriesTypeModalProps> = ({ open, onClose, editMode, methods, onSubmit, isLoading, selectedVenueType }) => {
  const handleClose = () => {
    if (!isLoading) {
      onClose();
    }
...
export default CategoriesTypeModal;
