...
const UserAccessTypeModal: React.FC<SupplierTypeModalProps> = ({
  open,
  onClose,
  editMode,
  methods,
        ...
        >
          <DialogHeader className="flex flex-row items-center justify-between">
            <DialogTitle className="text-lg font-semibold">
              {editMode ? 'Edit Access' : 'Create Access'}
            </DialogTitle>
          </DialogHeader>
             ...
             <div className="space-y-2">
              <RHFSelectField
                ...
                options={[
                  ...
                  { label: 'reservationManagement', value: 'reservationManagement' },
                  { label: 'loyaltyScanning', value: 'loyaltyScanning' },
                  { label: 'inAppOrdering', value: 'inAppOrdering' },
                ]}
              />
            </div>
...
export default UserAccessTypeModal;
