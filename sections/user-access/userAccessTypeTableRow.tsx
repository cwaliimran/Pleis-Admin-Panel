...
const UserAccessTypeTableRow: FC<PageProps> = ({ item, handleDelete, handleEdit }) => {
  return (
    <TableRow className="h-14 w-full transition-colors hover:bg-[#f5f5f5] dark:hover:bg-[#272727]/50">
      <TableCell className="text-left font-medium capitalize">{item?.title || '-'}</TableCell>

      <TableCell className="text-left font-medium">{item?.key || '-'}</TableCell>
...
export default UserAccessTypeTableRow;
