...
// import { stateToHTML } from 'draft-js-export-html';
// import { stateFromHTML } from 'draft-js-import-html';
// import { Bold, Heading1, Heading2, Heading3, Italic, List, ListOrdered, Save } from 'lucide-react';
// import React, { useCallback, useEffect, useState } from 'react';
...
//       if (response?.message) {
//         showSuccess(response.message || 'Terms & Conditions updated successfully');
//         // Update initial content after successful save
...
//                     </Button>
//                   ) : (
//                     <Button onClick={handleSave} size="sm" className="flex items-center gap-2" disabled={!hasChanges}>
//                       <Save className="h-4 w-4" />
//                       Save
//                     </Button>
//                   )}
