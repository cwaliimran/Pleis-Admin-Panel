...
const QueryDialog: FC<ConfirmDialogProps> = ({ open, title, content, onClose, onConfirm, isLoading, btnClassName }) => {
  return (
    <div>
          ...
          <DialogContent aria-describedby={undefined} className="dark:bg-secondary w-full max-w-md rounded-lg p-6 shadow-lg">
            ...
            <div className="flex justify-end space-x-2">
              ...
              {isLoading ? (
                ...
                <Button variant="default" className={`cursor-pointer ${btnClassName}`} onClick={onConfirm}>
                  Confirm
                </Button>
              )}
            </div>
