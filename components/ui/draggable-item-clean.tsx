...
export function DraggableItem({
  ...
  if (isOverlay) {
    return (
      <div className="flex items-center justify-between p-2 bg-white border border-gray-200 rounded-lg shadow-lg opacity-95 rotate-3 scale-105">
